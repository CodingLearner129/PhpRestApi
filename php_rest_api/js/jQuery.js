...
$(document).ready(function () {
    ...
    function loadTable() {
        $("#load-table").html("");
        $.ajax({
            url: 'http://localhost/php_rest_api/api_fetch_all.php',
            type: "GET",
            dataType : "json",
    ...
    $("#save-btn").on("click", function (e) {
        ...
        if (jsonData == false) {
            ...
            $.ajax({
                url: 'http://localhost/php_rest_api/api_insert.php',
                type: "POST",
                dataType : "json",
                data: jsonData,
                success: function (data) {
    ...
    $(document).on("click", ".delete-btn", function () {
        if (confirm("Do you really want to delete this record?")) {
            ...
            $.ajax({
                url: 'http://localhost/php_rest_api/api_delete.php',
                type: "POST",
                dataType : "json",
                data: myJSON,
                success: function (data) {
    ...
    $(document).on("click", ".edit-btn", function () {
        ...
        $.ajax({
            url: 'http://localhost/php_rest_api/api_fetch_single.php',
            type: "POST",
            dataType : "json",
            data: myJSON,
            success: function (data) {
    ...
    $("#update-edit-btn").on("click", function (e) {
        ...
        if (jsonData == false) {
            ...
            $.ajax({
                url: 'http://localhost/php_rest_api/api_update.php',
                type: "PUT",
                dataType : "json",
                data: jsonData,
                success: function (data) {
    ...
    $("#search-btn").on("click", function (e) {
        ...
        $.ajax({
            url: 'http://localhost/php_rest_api/api_search.php?key=' + searchValue,
            type: "POST",
            dataType : "json",
            success: function (data) {
                // console.log(data);
    ...
    $(document).on("keyup", "#search-key", function () {
        ...
        $.ajax({
            url: 'http://localhost/php_rest_api/api_search.php?key=' + searchTerm,
            type: "POST",
            dataType : "json",
            success: function (data) {
                // console.log(data);
